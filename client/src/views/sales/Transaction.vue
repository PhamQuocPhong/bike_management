  ...
  <v-layout row justify-center>
    <v-dialog v-model="salesTransaction" persistent max-width="1000">
      <v-card>
                      ...
                      <v-row >
                        ...
                        <v-card>
                          <div class="col col-12">
                            <p class="subtitle-2 text-right font-weight-bold"> Sub total: <span class="orange--text"> {{subTotalPrice | toCurrency}} $ </span></p>
                            <p class="subtitle-2 text-right font-weight-bold"> Tax price: <span class="orange--text"> {{taxPrice | toCurrency}} $ </span></p>
                            <p class="title text-right font-weight-bold"> Total price: <span class="orange--text"> {{finalTotalPrice | toCurrency}} $ </span></p>
          ...
          <v-card-actions>
            <v-spacer></v-spacer>
            <v-btn color="blue darken-1" outlined text @click.native="payment()">Payment</v-btn>
            <v-btn color="blue darken-1" outlined text @click.native="close">Cancel</v-btn>
          </v-card-actions>
      </v-card>
    </v-dialog>
    <confirm-dialog 
