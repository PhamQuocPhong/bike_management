                        ...
                        <v-expansion-panel-header v-slot="{ open }">
                          <v-row no-gutters>
                            <v-col cols="4" class="font-weight-bold">
                              {{ item.vehicle.name }}
                              <v-icon color="green" v-if="item.selected"
                          ...
                          >
                            <v-col cols="1">
                              <v-checkbox
                                ...
                                class="mt-0"
                                :disabled="
                                  getSales.salesCustomerBuy.status ==
                                    'completed'
                                "
                              ></v-checkbox>
                            </v-col>
...
export default {
  ...
  methods: {
    ...
    transaction() {
      this.vehiclesTransaction = this.vehicleSuggests.filter(
  ...
  computed: {
    ...
    vehicleSuggests() {
      return VehicleSuggest.query()
        .with("vehicle")
        .where("salesCustomerBuyId", this.getSales.salesCustomerBuy.id)
        .get();
    },
