					...
					<v-card tile>
	                  	...
	                  	ref="form">
	                  		<v-container>
			                    <v-row>
							      <v-col cols="4">
							        <v-subheader class="font-weight-bold">Full name</v-subheader>
							      </v-col>
							      <v-col cols="8">
							        <v-text-field 
							          :disabled="!edit"
							    ...
							    <v-row>
							      <v-col cols="4">
							        <v-subheader class="font-weight-bold">Email personal</v-subheader>
							      </v-col>
							      <v-col cols="8">
							        <v-text-field 
							          :disabled="!edit"
							    ...
							    <v-row>
							      <v-col cols="4">
							        <v-subheader class="font-weight-bold">Phone number</v-subheader>
							      </v-col>
							      <v-col cols="8">
							        <v-text-field 
							          :disabled="!edit"
							    ...
							    <v-row>
							      <v-col cols="4">
							        <v-subheader class="font-weight-bold">Address</v-subheader>
							      </v-col>
							      <v-col cols="8">
							        <v-textarea
							        	rows="3"
							    ...
							    <v-row>
							      <v-col cols="4">
							        <v-subheader class="font-weight-bold">Position</v-subheader>
							      </v-col>
							      <v-col cols="8">
							        <v-text-field 
							          :disabled="!edit"
