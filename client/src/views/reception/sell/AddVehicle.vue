<template>
  <v-layout row justify-center>
    <v-dialog v-model="receptionSellAddVehicle" persistent max-width="700" v-if="vehicleItem" >
      <v-card>
                ...
                <v-container>
                      <v-row>
                        ...
                        <v-col cols="6">
                          ...
                          :rules="[
                              $validation.required(vehicleItem.registrationPlate, 'Registration plate'), 
                          ]" 
                          ></v-text-field>
                        </v-col>
