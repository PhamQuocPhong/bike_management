		    		...
		    		<v-layout
			    		...
			    		<v-simple-table :class="{mobile: isMobile}">
						    <template v-slot:default v-if="!isMobile">
						      ...
						      <tbody>
						        <tr v-for="item in technicalRepairs" :key="item.id" v-if="loadData">
						        	<td>
						    ...
						    <template v-slot:default v-else>
						    	<tr v-for="item, index in technicalRepairs" :key="item.id" v-if="loadData">
						        	<td>
						        		<ul class="flex-content">
						        			<li class="flex-item" data-label="No."> 
						        				{{$helper.indexColumn(item, technicalRepairs)}}
						        			</li>
						        			<li class="flex-item" data-label="Accessory">{{item.accessory}}</li>
						        			<li class="flex-item" data-label="Start date">{{$helper.formatDate(item.startDate)}}</li>
						        			<li class="flex-item" data-label="End date">{{$helper.formatDate(item.endDate)}}</li>
