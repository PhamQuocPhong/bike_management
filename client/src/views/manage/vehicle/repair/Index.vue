		    			...
		    			>
			    		  	<v-simple-table :class="{mobile: isMobile}">
							    ...
							    <template v-slot:default v-else>
							    	<tr v-for="item, index in vehicleRepairs" :key="item.id" v-if="loadData">
							        	<td>
							        		<ul class="flex-content">
								        		<li class="flex-item" data-label="No.">
									        		{{$helper.indexColumn(item, vehicleRepairs)}}
									        	</li>
										    	<li class="flex-item" data-label="Vehicle name">{{item.vehiclePurchase.name}}</li>
										    	<li class="flex-item" data-label="Image">
										    		<v-img  height="50" width="70" contain :src="item.vehiclePurchase.image"></v-img>
										    	</li>
										    	...
										    	<li class="flex-item" data-label="Total fix price">
										    		{{item.fixPrice | toCurrency}}</li>
										    	<li class="flex-item" data-label="Buy price">
										    		{{item.vehiclePurchase.price | toCurrency}}
										    	</li>
										    	<li class="flex-item font-weight-bold" data-label="Aprrove price">
										    	...
										    	<li class="flex-item" data-label="Note">{{item.note}}</li>
