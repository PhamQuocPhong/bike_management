<template>
  <div>
    <v-layout row justify-center>
      <v-dialog v-model="dialogAddFixDetail" persistent max-width="900" >
        <v-card>
            <v-card-title class="headline d-flex pb-4"> Add Fix Detail </v-card-title>
...
export default {
    ...
    props: ['dialogAddFixDetail', 'vehicleRepairId'],
    ...
    methods: {
      ...
      close(){
        this.$emit('update:dialogAddFixDetail', false)
      },
